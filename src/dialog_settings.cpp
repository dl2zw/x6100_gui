...
static void spectrum_color_update_cb(lv_event_t * e) {
    lv_obj_t        *obj = lv_event_get_target(e);
    params_uint8_t  *var = (params_uint8_t*)lv_event_get_user_data(e);
...
static uint8_t make_spectrum_color(uint8_t row) {
    lv_obj_t    *obj;
    uint8_t     col = 0;
    ...
    obj = dropdown_uint8(grid, &params.spectrum_color, " Gray \n Green \n Yellow");
